...
function echoJS()
{
	...
	if(!empty($userid)&&$userid!='﻿'){
		echo file_get_contents("./js/exercise_start.js"); 
		journal('zztk_start','approved: '. $userid);
	}
	else{
...
<body>
	<div id="inform">
        ...
        <div id="sgid"><?php echoGID(); ?></div>
		<div id="appn"><?php echoName(); ?></div>
		<div id="appm"><?php echoMark(); ?></div>
		<div id="cr_l"><?php echoColor('start_light'); ?></div>
		<div id="cr_d"><?php echoColor('start_dark'); ?></div>
    </div>
    <div id="container">
        <div id="header"></div>
        <div id="content">
