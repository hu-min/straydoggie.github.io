...
function echoJS()
{
	...
	if(!empty($userid)&&$userid!=''){
		echo file_get_contents("./js/exercise_review.js"); 
		journal('zztk_review','approved: '. $userid);
	}
	else{
...
<body>
	<div id="inform">
		...
		<div id="cr_l"><?php echoColor('review_light'); ?></div>
		<div id="cr_d"><?php echoColor('review_dark'); ?></div>
    </div>
    <div id="container">
        <div id="header"></div>
        <div id="content">
